  ...
  public class UserClaimConfiguration : IEntityTypeConfiguration<UserClaim>
    {
        public void Configure(EntityTypeBuilder<UserClaim> builder)
        {
            ...
            builder.HasData(
                // ---- User 1
                new UserClaim { Id = 1, SubjectId = subjectId1, ClaimType = "given_name", ClaimValue = "MohammadJavad" },
                new UserClaim { Id = 2, SubjectId = subjectId1, ClaimType = "family_name", ClaimValue = "Tavakoli" },
